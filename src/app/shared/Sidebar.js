        ...
        <ul className="nav">
            ...
            <Collapse in={ this.state.multisenderMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  ...
                  <li className="nav-item"> <Link className={ this.isPathActive('/launchpad/launchpad-listings') ? 'nav-link active' : 'nav-link' } to="/launchpad/launchpad-listings"><Trans>MultiSender NFTs</Trans></Link></li>
                  {/* <li className="nav-item"> <Link className={ this.isPathActive('/launchpad/launchpad-listings') ? 'nav-link active' : 'nav-link' } to="/launchpad/presale-live"><Trans>Presale Live</Trans></Link></li> */}
                </ul>
              </div>
            </Collapse>
          </li>
          ...
          {/* <li className={ this.isPathActive('/tables') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.tablesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('tablesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Revoke</Trans></span>
              <i className="menu-arrow"></i>
            </div>

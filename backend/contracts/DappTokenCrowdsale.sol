...
contract DappTokenCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, WhitelistedCrowdsale, RefundableCrowdsale {
  ...
  struct AdditionialInformation{
    ...
    string provideParticipants;
  }

  AdditionialInformation public additionalInformtion;
  ...
  constructor(
    ...
    AdditionialInformation _additionialInformation
  )
    ...
    public
  {
    ...
    additionalInformtion    = _additionalInformtion;
  }
